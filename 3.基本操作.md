...
** 示例9: 删除student集合中的三个文档，然后通过insertOne()插入1个文档，利用insertMany()插入2个文档。**
```javascript
> db.student.drop()
true
...
** 例11 查看student集合中student_id为2015210315的文档，查看所有学生的姓名。**
```javascript
...
** 例10 将student_name为李想的文档的gender更新为女**
```javascript
