...
<B> 示例9: 删除student集合中的三个文档，然后通过insert()插入2个文档，利用insertMany()插入2个文档。</B>
```javascript
> db.student.drop()
true
> var x1 = [
...
2. 使用insertMany()往course集合插入以下三个文档:`{'course_id': 'BIO-399', 'title': 'Computational Biology', 'dept_name': 'Biology'}
