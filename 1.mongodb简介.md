...
4. 启动mongodb: <u>mongod --dbpath "d:\mongodb\data\db"</u> (如果提示engine是错的，则在以上语句最后附上example提示内容)
*注意：在win32中，默认引擎为WiredTiger，但32位置支持MMAPv1引擎，所以在启动服务时应加上storageEngine参数: * <u>mongod --dbpath "d:\mongodb\data\db" --storageEngine=mmapv1</u>

5. 注册mongodb服务: <u>mongod --dbpath "d:\mongodb\data\db" --logpath "d:\mongodb\log\mongdb.log" --install --serviceName "MongoDB" —journal</u>
注意：在win32中，默认引擎为WiredTiger，但32位置支持MMAPv1引擎，所以在启动服务时应加上storageEngine参数: <u>mongod --dbpath "d:\mongodb\data\db" --storageEngine=mmapv1 --logpath "d:\mongodb\log\mongdb.log" --install --serviceName "MongoDB" —journal</u>

6. 启动mongodb服务: <u>net start mongodb</u>
或者 在服务列表当中更改mongodb服务的属性
7. 进入mongodb: <u>mongo</u>
