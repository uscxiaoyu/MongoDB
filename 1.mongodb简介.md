...
### 3.1 Windows安装和启动
    ...
    4. 启动mongodb： > mongod --dbpath "d:\mongodb\data\db" (如果提示engine是错的，则在以上语句最后附上example提示内容)
    ...
    5. 注册mongodb服务：> mongod --dbpath "d:\mongodb\data\db" --logpath "d:\mongodb\log\mongdb.log" --install --serviceName "MongoDB" —journal
    注意：在win32中，默认引擎为WiredTiger，但32位置支持MMAPv1引擎，所以在启动服务时应加上storageEngine参数:
